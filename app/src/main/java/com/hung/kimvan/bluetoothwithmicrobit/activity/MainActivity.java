...
import com.hung.kimvan.bluetoothwithmicrobit.help.Settings;
import com.hung.kimvan.bluetoothwithmicrobit.help.Utility;
import com.hung.kimvan.bluetoothwithmicrobit.bluetooth.BleScanner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                intent.putExtra(ControlActivity.EXTRA_NAME, device.getName());
                intent.putExtra(ControlActivity.EXTRA_ID, device.getAddress());
