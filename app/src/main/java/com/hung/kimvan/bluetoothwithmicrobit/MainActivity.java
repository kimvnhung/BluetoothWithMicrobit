...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<String> listDeviceNames;
    ...
    private BroadcastReceiver mBroadcastReceiver3 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_FOUND)){
                ...
                mDeviceListAdapter = new DeviceListAdapter(context, R.layout.device_adapter_view, listDevices);
    ...
    private BroadcastReceiver mBroadcastReceiver4 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_BOND_STATE_CHANGED)){
                BluetoothDevice device = intent.getParcelableExtra(BluetoothDevice.EXTRA_DEVICE);
                Toast.makeText(getApplicationContext(),device.getBondState()+"",Toast.LENGTH_SHORT).show();
            }
        }
    };
}
