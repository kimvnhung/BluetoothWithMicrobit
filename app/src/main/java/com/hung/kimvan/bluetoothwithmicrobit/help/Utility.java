...
public class Utility {
    ...
    /**
     * @see_ http://en.wikipedia.org/wiki/Low-pass_filter#Algorithmic_implementation
     * @see_ http://developer.android.com/reference/android/hardware/SensorEvent.html#values
     */
